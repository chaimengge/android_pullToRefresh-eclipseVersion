...
import com.example.pulltorefreshtest.lib.PullToRefreshBase.OnRefreshListener2;
import com.example.pulltorefreshtest.lib.PullToRefreshListView;


public class PullToRefreshListInViewPagerActivity extends Activity implements OnRefreshListener2<ListView> {
	...
	public void onPullUpToRefresh(final PullToRefreshBase<ListView> refreshView) {
		new Handler().postDelayed(new Runnable() {
			...
			@Override
			public void run() {
				Toast.makeText(PullToRefreshListInViewPagerActivity.this, "加载更多完毕", 2000).show();
